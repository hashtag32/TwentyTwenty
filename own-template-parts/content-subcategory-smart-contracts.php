	...
	<div class="post-inner">
		...
		<div id="BettingDiv" style="display: none;" > 
			...
			<a href="https://ropsten.etherscan.io/address/">
				<h2 class="own-h2 has-text-align-center ">...0xce7f64728e998ad96bd82e8b0603b9a3e32cf8f7</h2>
			</a>
			...
			<form>
				...
				<div class="form-group text-center"> 
					<button type="button" class="btn btn-primary btn-lg" id="SendBetButton">Send bet</button>
				</div> 
			</form>
...
<!-- 
	...
	async function createNewContract(web3) {
		...
		// var contractInstance = await newContract.new(30, {data: byteCode, from: firstAccount, gas: 1000000});
