						...
						<table>
							<tbody>
								...
								<tr>
									...
									<td>
										<3</td> </tr> </tbody> </table> </figure> <h2>Growth</h2>
											<figure class="wp-block-table is-style-stripes">
												<table>
													<tbody>
														<tr>
												...
												<table>
													<tbody>
														...
														<tr>
															...
															<td>
																<1.5, ideal 1 </td> </tr> </tbody> </table> </figure> <h2>Rating</h2>
																	<figure class="wp-block-table is-style-stripes">
																		<table>
																			<tbody>
																				<tr>
				...
				<div class="wp-block-column">
					...
					<div class=" has-text-align-center ">
						...
						<form name="vote_form" method="post">
							...
							<input type="button" class="button-voting" onclick="send_vote(this,'<?php echo $symbol;  ?>',voting_input_<?php echo $symbol;  ?>.value)" value="Vote" alt="Thank you!" />
							<input type="button" class="button-voting" onclick="window.location = 'https://stockvoting.net/smart-contracts';" value="Bet" alt="Thank you!" />
						</form>
					</div> <!-- Button section -->
				</div><!-- /wp:top-column -->
			</div><!-- /wp:top-columns -->
